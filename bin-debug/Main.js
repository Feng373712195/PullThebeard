...
var Main = (function (_super) {
    ...
    Main.prototype.drawGame = function () {
        ...
        var start = new StartView(this.stage.stageWidth, this.stage.stageHeight);
        var menuView = menu.draw();
        var gameView = game.draw();
        var startView = start.draw();
        ...
        var onStartGame = function () { return __awaiter(_this, void 0, void 0, function () {
...
var StartView = (function () {
    function StartView(stageW, stageH) {
        this.stageW = stageW;
        this.stageH = stageH;
    }
    ...
    StartView.prototype.showText = function () {
        var _this = this;
        return new Promise(function (resolve) {
            var tw = egret.Tween.get(_this.startText);
